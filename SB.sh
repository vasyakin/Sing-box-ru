...
agsbxurl="https://raw.githubusercontent.com/vasyakin/Sing-box-ru/refs/heads/main/SB.sh"
showmode(){
echo "Онлайн-генератор SSH-команд для скрипта Argosbx: https://yonggekkk.github.io/argosbx/"
echo "Основной скрипт: bash <(curl -Ls https://raw.githubusercontent.com/vasyakin/Sing-box-ru/refs/heads/main/SB.sh) или bash <(wget -qO- https://raw.githubusercontent.com/vasyakin/Sing-box-ru/refs/heads/main/SB.sh)"
